...
class AudioHandler:
    ...
    def __init__(self, config):
        ...
        self.num_audio_features = 29 #config['num_audio_features']
        self.audio_window_size = 16 #config['audio_window_size']
        self.audio_window_stride = 1 #config['audio_window_stride']
