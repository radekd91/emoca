...
def finetune_deca(cfg_coarse, cfg_detail):
    ...
    for i, cfg in enumerate(configs):
        if i > 0:
            deca.reconfigure(cfg.model, cfg.inout, cfg.learning)
...
# @hydra.main(config_path="../emoca_conf", config_name="deca_finetune_coarse")
# @hydra.main(config_path="../emoca_conf", config_name="deca_finetune_all")
