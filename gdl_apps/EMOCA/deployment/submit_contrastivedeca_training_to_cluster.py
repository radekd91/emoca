...
def train_on_selected_sequences():
    ...
    finetune_modes = [
        ...
        # ],
        #
        # # EMOCA cloned trainable backbone, DISABLED UNNECESSARY DEEP LOSSES, HIGHER BATCH SIZE, NO SHAPE RING, RENDERED MASK
        # [
        #     ['model.useSeg=rend', 'model.idw=0', 'learning/batching=single_gpu_expdeca_coarse',
        #      'model.shape_constrain_type=None', 'learning.batch_size_test=1',
        ...
        # # REGULAR EMOCA, DISABLED UNNECESSARY DEEP LOSSES, HIGHER BATCH SIZE, NO SHAPE RING, RENDERED MASK
        # [
        #     ['model.useSeg=rend', 'model.idw=0',
        #      'model.max_epochs=8',
        ...
        # ],
        #
        # # REGULAR EMOCA, DISABLED UNNECESSARY DEEP LOSSES, HIGHER BATCH SIZE, NO SHAPE RING, RENDERED MASK, DETAIL WITH COARSE
        # [
        #     ['model.useSeg=rend', 'model.idw=0',
        #      'model.max_epochs=8',
        #      'learning/batching=single_gpu_expdeca_coarse',
    ...
    # resume_from = None # resume from Original EMOCA
    # resume_from = "/is/cluster/work/rdanecek/emoca/finetune_deca/2021_08_26_21-50-45_DECA__DeSegFalse_early/" # My EMOCA, ResNet backbones
    # resume_from = "/is/cluster/work/rdanecek/emoca/finetune_deca/2021_08_26_23-19-03_DECA__EFswin_s_EDswin_s_DeSegFalse_early/" # My EMOCA, SWIN small
    # resume_from = "/is/cluster/work/rdanecek/emoca/finetune_deca/2021_08_26_23-19-04_DECA__EFswin_t_EDswin_t_DeSegFalse_early/" # My EMOCA, SWIN tiny
    resume_from = "/is/cluster/work/rdanecek/emoca/finetune_deca/2021_10_15_13-32-33_DECA__DeSegFalse_early/" # My EMOCA, large batch size
    ...
    fixed_overrides_coarse = [
        ...
        f'model.resume_training={resume_from == None}', # load the original EMOCA model
