...
def train_on_selected_sequences():
    ...
    finetune_modes = [
        ...
        # NEW GENERATION EXPERIMENTS (AFTER CONFIG SYNC WITH RELEASED EMOCA)

        # [[], [], []],# default, ResNet encoders, without emonet loss

        # [   ['learning/batching=two_gpu_coarse_pretrain_32gb', 'learning.learning_rate=0.0015'],
        #     ['learning/batching=two_gpu_coarse_32gb', 'learning.learning_rate=0.0015'],
