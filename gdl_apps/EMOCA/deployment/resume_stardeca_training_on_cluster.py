...
import gdl_apps.EMOCA.training.resume_stardeca_training as resume_stardeca_training
import datetime
...
def submit(
    ...
    local_script_path = Path(resume_stardeca_training.__file__).absolute()
...
def main():
    ...
    # resume_folders += ["/is/cluster/work/rdanecek/emoca/finetune_deca/2021_10_13_10-49-29_DECA_DecaD_NoRing_VGGl_DeSegrend_idBT-ft_early"]
