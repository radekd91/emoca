...
def main():
    ...
    final_model_nicknames["-7787195888843808313"] = "EMOCA" # with identity
    final_model_nicknames["7017738612092177501"] = "EMOCA detail" # with identity and detail
    ...
    order["EMOCA"] = idx; idx+=1
    order["EMOCA detail"] =  idx; idx+=1
